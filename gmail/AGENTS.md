...
- `config.jsonnet` — renders the blocklist into gmailctl rules; `gmailctl apply --config ~/frame/gmail`
...
new account, or after hand-made filters in the web ui, run `gmailctl download --config ~/frame/gmail`

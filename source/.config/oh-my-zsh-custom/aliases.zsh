...
# Membank shortcuts (equivalent to pnpm mem:* commands)
alias mem-add='cd ~/.dotfiles && pnpm mem:add'
alias mem-list='cd ~/.dotfiles && pnpm mem:list'
alias mem-update='cd ~/.dotfiles && pnpm mem:update'
alias mem-delete='cd ~/.dotfiles && pnpm mem:delete'
alias mem-read='cd ~/.dotfiles && pnpm mem:read'
alias mem-search='cd ~/.dotfiles && pnpm mem:search'
alias mem-server-start='cd ~/.dotfiles && pnpm mem:server:start'
alias mem-server-stop='cd ~/.dotfiles && pnpm mem:server:stop'
alias mem-server-status='cd ~/.dotfiles && pnpm mem:server:status'
alias mem-db-explore='cd ~/.dotfiles && pnpm mem:db:explore'
alias mem-db-init='cd ~/.dotfiles && pnpm mem:db:init'

 ...
 * grouped by master, with the chars it costs in dima's `account / profile / instructions` field and the room
...
title('memory-sync:map', 'cc masters → cw · account / profile / instructions');

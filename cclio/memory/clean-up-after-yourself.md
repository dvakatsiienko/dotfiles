...
- **exemption:** `docs/research/*` is kept — deletion there is his manual call. The duty is linkage
  (`Ticket: DOT-N` at the top), not removal.

🌍 A fleet-wide habit, not a coordinator quirk. Queue it on
[DOT-186](linear://linear.app/issue/DOT-186); never push it into another surface's store yourself.

...
1. **Fleet workflow vocabulary** — vet, slay, run ids, spawn types, CST, vikar etc. is a bounded-context glossary; it belongs in one CONTEXT.md-shaped file all surfaces read (folds into the mem-revamp / DOT-73 story), not scattered across memory files. Hard-to-reverse fleet decisions get one-paragraph ADRs.

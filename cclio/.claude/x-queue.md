...
- ⏸️ linear-users research → proposal for dima's admin hands (dima 2026-08-31: after long-standing pm topics) — added angle: assignee utilization — how/when to set an assignee once agent users exist; today assignees ≈ unused (dima only, on purely-his tickets)

...
- 🎓 shell walkthrough — dima's ask from DOT-17: where `ls`, `cd` come from, builtins vs binaries vs functions, how zsh loads; `x:walkthrough`, one evening, artifact at the end. next session, not now (2026-09-02)

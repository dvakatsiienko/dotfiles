...
- [skill authoring](agents/skill-authoring.md) — the full reference for writing a skill: frontmatter, `intended-models:`, invocation control, the listing budget
- [memory authoring](agents/memory-authoring.md) — where a fact goes, decided BEFORE it is written: the pre-write checklist, bucket tests, silent hazards

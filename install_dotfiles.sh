...
# files=".zshrc .zprofile .zshenv .vimrc .yarnrc .hushlogin" # ? list of files/folders to symlink in homedir. Description of zsh files https://apple.stackexchange.com/questions/388622/zsh-zprofile-zshrc-zlogin-what-goes-where
